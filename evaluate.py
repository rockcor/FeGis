...
def evaluate(task_predictor,task_predictor_finetune,embeds, idx_train, idx_val, idx_test, labels, task,epoch,lr ,isTest=True, iterater=10):
    ...
    macro_f1s = []
    macro_f1s_val = []
    task_predictor_finetune.load_state_dict(task_predictor.state_dict())
    
    for _ in range(iterater):
        log = task_predictor_finetune
